...
open BST.StagedBespoke
open BST.BaseSinglePass
open BST.Staged
open Crowbar
open Util.Runner
open Util.Io
(* Import the runner components *)
...
let bstrategies : (string * tree basegen) list =
  [ ("type", (module BaseType)); ("bespoke", (module BaseBespoke)); ("staged", (module Staged)) ]
...
let bstrategies : (string * tree basegen) list =
    [ ("type", (module BaseType)); ("bespoke", (module BaseBespoke)); ("staged", (module Staged)); ("max", (module StagedBespoke)); ("single", (module BaseSinglePass)) ]
