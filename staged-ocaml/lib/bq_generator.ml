...
let int = Base_quickcheck.Generator.int
let int_uniform = Base_quickcheck.Generator.int_uniform
let int_inclusive ~lo ~hi = Base_quickcheck.Generator.int_inclusive lo hi
