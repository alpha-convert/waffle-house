...
external int_c_unchecked : t -> int -> int -> int = "int_c_unchecked"  [@@noalloc]
external int_c_log_uniform : t -> int -> int -> int = "int_c_log_uniform"  [@@noalloc]
external bool_c : t -> bool = "bool_c"  [@@noalloc]
