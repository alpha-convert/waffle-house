...
\newcommand{\name}{{Allegro}\xspace}
\newcommand{\camlname}{AllegrOCaml\xspace}
\newcommand{\scalaname}{ScAllegro\xspace}
\newcommand{\tool}{Waffle House\xspace}
\newcommand{\rand}{randomness library\xspace}
\newcommand{\rands}{randomness libraries\xspace}
\newcommand{\randshyphenated}{randomness-libraries\xspace}
