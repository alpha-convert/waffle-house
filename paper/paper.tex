...
faster also find bugs faster by running our case studies in the Etna
platform~\cite{etna}, which injects bugs into a system and measures
how quickly various generators detect them. In Etna, we find bugs up 
to $3.8\times$ faster on average, and up to $13\times$ in some cases.
