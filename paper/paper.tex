...
\jwc{
  \begin{itemize}
    \item Because the RNG sits at the heart of the generation hot path, RNG speed matters enormously.
    \item To illustrate this, we demonstrate a particular inefficiency of
    ...
    \item We also demonstrate how using an inequivalent RNG
    \item Scalacheck uses a faster RNG called ``xoroshiro128++'' \cn{}.
    % https://lemire.me/blog/2019/03/19/the-fastest-conventional-random-number-generator-that-can-pass-big-crush/
    \item One could go even faster, using \href{https://lemire.me/blog/2019/03/19/the-fastest-conventional-random-number-generator-that-can-pass-big-crush/}{even faster RNG} with less guarantees.
  \end{itemize}
}
