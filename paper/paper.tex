...
many common generator abstractions using \textit{multi-stage
  programming} (or {\em staging}), a well-studied technique for
building fast DSLs "without regret"~\cite{lms}. Beyond the standard
staging transformations, we apply advanced staging techniques~\cite{partially-static,kovacs24, carrette05}
...
\item We present a novel methodology for quantifying 
