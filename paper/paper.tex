...
eta (succ . is_even)
\end{lstlisting}
This is equal to \texttt{.< fun x -> (1 + x) mod 2 == 0 >.}: the functions have been fused together, and the overhead of calling them is not present at runtime.

This ``trick'' is how we use metaprogramming
