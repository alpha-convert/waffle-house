...
\jwc{This needs to be smith'd}
For example, significantly faster algorithms than SplitMix or JSF exist,
such as the Lehmer algorithm\cn, which runs almost 2x as fast as SplitMix in microbenchmarks \cn.
\jwc{also Wyhash, xoroshiro128plus}
...
simply swap out the randomness library of either \bq{} or ScalaCheck with a totally different, faster one.
...
\texttt{Splittable\_random}---the \rand{} that \bq{} uses---is slow in a way that
