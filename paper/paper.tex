...
\jwc{Same story in scala. Approximately 2x difference for the same generator... (scala uses a slightly different generator type, but the principles are the same)}
