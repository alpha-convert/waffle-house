...
runtime overhead of many common generator abstractions. For instance, in
...
\subsection{Existing PBT Generators}
...
\jwc{
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item This gets a monad intance in the obvious way
    \end{itemize}
  \end{itemize}
}
