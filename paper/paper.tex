...
an easy-to-fix way, we perform a controlled experiment, comparing fast and slow
versions of the same library to analyze the impact of faster \rand{} on
...
\begin{figure}[h]
  \includegraphics[scale=0.46]{bind.pdf}
...
\begin{figure}[h]
  \includegraphics[scale=0.45]{speedup.pdf}
...
\begin{figure}[h]
  \includegraphics[scale=0.35]{swarm.pdf}
