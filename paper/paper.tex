...
for example the Lehmer algorithm\cn. In microbenchmarks, the Lehmer algorithm runs almost 2x as fast as SplitMix \cn.
...
\bcp{Again, we could lean into the technical contribution here}\jwc{This is also totally standard.}
...
overhead. This result demonstrates the generality of \name generators.
