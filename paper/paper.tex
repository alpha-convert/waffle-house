...
For instance, to generate a single list with 3 elements, 
\hg{To generate a single list with 3 elements, \bq's list generator calls the RNG \dots times!}
...
\hg{Alternative framing: ``'': \dots''}
Of course, simply arguing that the RNG is on the hot
