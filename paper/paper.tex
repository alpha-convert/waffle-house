...
\begin{abstract}
  ...
  Scala 3 to use the \name approach, preserving the original library's semantics and enabling precise performance comparisons. We also show that \rand
  has a measurable impact on generator performance, quantify its contribution, and show that speedups of $5.5\times$ are possible. Together, these contributions
  lead to up to $13\times$ faster bug finding, showing that high-level generator abstractions need not come at the cost of speed.
\end{abstract}
