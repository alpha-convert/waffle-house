...
To test this idea, we need measurable proxies that approximate a generator's reliance on its generator and randomness libraries.
...
to \texttt{bind}. The right plot shows a clear separation between 
...
\begin{figure}[h]
  ...
  \caption{Distribution of individual-task speedups across strategies and benchmarks. Gray dots represent tasks. Plots with extremely low variance have no swarm overlay; in plots with high variance, outliers correspond to large speedups.}
  \label{fig:swarm}
\end{figure}
