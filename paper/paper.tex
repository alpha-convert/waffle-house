...
\title{Fail Faster}
\subtitle{Multi-Stage Programming and Fast Randomness for High-Performance PBT}
...
integers, so this \emph{particular} inefficiency does not exist. \bcp{This paragraph should go on to explain why it is still interesting to talk about or measure it.}
...
The precise details of the SplitMix algorithm~\cn are not important for
