...
our staged program in continuation-passing style \cite{bondorf92, carrette05}.

In Figure~\ref{fig:codecps-and-final-gen}, we follow \citet{kovacs24} and define the type \texttt{'a CodeCps.t = 'z. ('a -> 'z code) -> 'z code}. This is the polymorphic CPS monad, with the continuation type always in \texttt{code}.
\footnote{
This is an instance of the \emph{codensity} monad \cite{janis08}.
}
