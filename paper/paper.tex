...
\\
\tr{Property-based testing (PBT) uses generators of random data to produce inputs to a
system under test, which is then checked against a set of properties the system is
 ...
 it is 
 imperative that inputs be generated as fast as possible; in other words, 
 generators must be treated as performance-sensitive code.}

\tr{The locus for improvement in this area is \textit{generator libraries}: if programmers are 
...
\\
\tr{ Introduce waffle house... }
\tr{Harry's ``methodology'' paragraph...}
