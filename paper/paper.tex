...
Further,
we show that generators that run
faster also find bugs faster by running our case studies in the Etna platform, which uses generated values as
inputs to a pre-defined buggy system and measures how quickly different generators can detect the bugs.
Combined with fast randomness, \camlname generators find bugs 
to $2.3-3.8\times$ faster on average, and up to $13\times$ in some cases.
