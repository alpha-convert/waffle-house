...
In the staging literature, this task is known as ``binding-time analysis,'' and it is more art than science.
...
generator. This function is just a 2-argument version of ``The Trick'' 
...
at most a few dozen elements --- each allocation takes us closer to the next garbage collection, which is bad for performance.
