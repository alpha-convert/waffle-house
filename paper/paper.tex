...
Muli-stage programming (also known more simply as staging) is \jwc{finish}
...
\jwc{Staging has a long history as a technique for eliminating the runtime overhead of abstractions,
