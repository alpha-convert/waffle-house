...
a \texttt{weighted\_union} of the generators for each case; and recursive types are handled by 
tying the knot at the generator level---recursive references are treated as parameters during 
derivation, allowing the generator's structure to be defined first and then closed using a 
