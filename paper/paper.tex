...
random test inputs to validate logical specifications. A recent study
...
building fast DSLs “without regret”~\cn{}.  We refer to this approach as \name.
%
...
OCaml, authored by software engineers at the trading firm Jane Street
\cn{}.  In Scala 3, we build \scalaname{}, based on ScalaCheck---the
language's standard PBT library\cn{}.

We isolate and quantify the performance benefits of faster randomness,
showing that a DSL's choice of \rand{} has a dramatic impact on its
performance.  \bcp{describe the experiment}
