...
long been used to eliminating overhead 
from idiomatic functional DSLs \todo{CITE!!!}.
Using staging, it is possible to eliminate the overhead of many common 
generator abstractions. For example, in unstaged generator libraries, each call to monadic bind constructs and immediately executes a closure at runtime.
