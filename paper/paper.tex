...
the end user does not need to understand the staging syntax---but more importantly, applying \name to type-derivation
means it is more likely for even naive strategies to find a bug. \tr{TODO}
...
\subsubsection{Do staged type-derived generators reduce timeouts?}
...
50 (64\%) completed successfully after our interventions. 
